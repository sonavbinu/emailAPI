 ...
 */
router.post('/send', validation_1.validateEmailRequest, emailController_1.sendEmailController);
/**
 * @swagger
 * /api/email/history:
 *   get:
 ...
 *         description: Server error
 */
router.get('/history', emailController_1.getEmailHistory);
/**
 * @swagger
 * /api/email/{id}:
 *   get:
 ...
 *         description: Server error
 */
router.get('/:id', emailController_1.getEmailById);
